      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex flex-row">
          <div>
            ...
            <p className="my-5">As an African American software engineer in a field where there is somewhat a lack of diversity, I&apos;m committed to using my skills to not only make a positive impact in the world but also to inspire others from underrepresented communities to pursue careers in tech. I recognize the challenges that come with being a minority in this industry, and I want to use my experiences to help others overcome similar obstacles.</p>
            <p className="my-5">In my experience, a more diverse workforce in the tech industry brings fresh perspectives and ideas, leading to more innovative solutions and I want to help create a more inclusive industry for future generations.</p>
